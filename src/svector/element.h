 ...
 * 
 * The Element structure is used to store an of a vector in terms of the label \f$\ell\f$ (i.e., index) and the value \f$v_\ell\f$.
 * 
 * @warning For all operations involving multiple Element objects, it is assumed the labels are the same
 * 
 */

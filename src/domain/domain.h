...
struct Domain
{
     ...
     * 
     * For each ELA instance, `n` in `0` to \ref nn -1, the corresponding source vector field is accessed through `s[n]`.
     * 
     */
     ...
     * 
     * For each ELA instance, `n` in `0` to \ref nn -1, the corresponding vector dilation field is accessed through `c[n]`.
     * 
     */
